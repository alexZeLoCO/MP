...
public abstract class Monster extends Character implements Suspect {
	...
	public void resolveTurn(Game currentGame) {
		if (this.getNoPlayTurns()==0) {
			...
			System.out.printf("%s is in a No Play Turn.\n",this.getName());
			this.setNoPlayTurns(this.getNoPlayTurns()-1);
			System.out.printf("No play turns remaining: %d.\n",this.getNoPlayTurns());
		}
	}
}
